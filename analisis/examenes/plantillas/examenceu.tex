...
\hline
\multirow{4}{*}{\includegraphics[width=0.15\textwidth]{/run/media/alf/datos/misrepositorios/docencia/repositorio-ejercicios/img/logoceu.jpg}} & \multicolumn{2}{c|}{\LARGE \textbf{EXAMEN DE \myTitle}} \\
\cline{2-3}
& \myDegree & Nombre: \\
\cline{2-3}
