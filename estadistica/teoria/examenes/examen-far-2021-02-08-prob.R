...
exams2pdf(questions, n=1, name = c("examen-far-2021-02-08-prob", "solucion-far-2021-02-08-prob"), encoding = "UTF-8",
  dir = "pdf",
  edir = "../preguntas",
...
exams2pandoc(questions, n=1, 
            name = "examen-far-2021-02-08-prob", 
            encoding = "UTF-8", 
            type="latex",
            dir = "latex",
            edir = "../preguntas",
...
pandoc("latex/examen-far-2021-02-08-prob1.latex", format="markdown")
