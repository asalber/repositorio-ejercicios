...
exams2pdf(questions, n=1, name = c("examen-far-2020-11-13", "solucion-far-2020-11-13"), encoding = "UTF-8",
  dir = "pdf",
  edir = "../preguntas",
...
pandoc("latex/examen-far-2020-11-131.latex", format="markdown")
