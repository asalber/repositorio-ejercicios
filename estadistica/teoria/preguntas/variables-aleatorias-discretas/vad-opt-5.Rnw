...
\begin{question}
\puntos{2}Se sabe que el 90\% de las personas miopes de una población usan lentillas. Calcular:
\begin{enumerate}
\item La probabilidad de que en una muestra de 6 personas miopes haya más de 4 que usen lentillas. 
\item La probabilidad de que en una muestra de 100 personas haya al menos 3 que no usen lentillas.
\end{enumerate}
\end{question}
