...
exams2pdf(questions, n=1, name = c("examen-far-2021-02-08", "solucion-far-2021-02-08"), encoding = "UTF-8",
  dir = "pdf",
  edir = "../preguntas",
...
pandoc("latex/examen-far-2021-02-081.latex", format="markdown")
